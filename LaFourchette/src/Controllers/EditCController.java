...
@FXML
    ...
    @FXML
    private TextField tfreferenceplat;
    @FXML
    ...
    public void setText(commande t) 
    {
       ...
       // System.out.println(t.getId());
        ...
        tfreferenceplat.setText(t.getReferenceplat());
    ...
    private void modifierFormateur(ActionEvent event) throws SQLException, IOException {
     ...
     String referenceplat= tfreferenceplat.getText();
         ...
         commande c;
           c = new commande(idC,referenceplat,idU,quantity,livraison,prixC) ;
           p.modifier(c);

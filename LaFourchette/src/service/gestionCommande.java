   ...
   public gestionCommande () {
     ...
     /* public void ajoutercommande(){
      ...
      public void modifier(commande c) {
         try {
       String query2="update commande set  idU=?,etatC=?,livraison=?,prixC=?  where idC=?";
                PreparedStatement pst = cnx.prepareStatement(query2);
                pst.setInt(5,c.getIdC()); 
               pst.setInt(1,c.getIdU());
              
          //    pst.setString(2,c.getReferenceP());
              pst.setString(2,c.getEtatC());
               pst.setString(3,c.getLivraison());
                pst.setDouble(4,c.getPrixC());
        ...
        try { 
            ...
            while(rs.next()){
              // co=new commande(rs.getInt("idC"),rs.getInt("idU"),rs.getString("referenceP"),rs.getString("etatC"),rs.getString("livraison"),rs.getDouble("prixC"));
               co=new commande(rs.getInt("idC"),rs.getInt("idU"),rs.getString("etatC"),rs.getString("livraison"),rs.getDouble("prixC"));
               l.add(co);
            }
          //  System.out.println();
        } catch (SQLException ex) {
        ...
        try {
            ...
            while(rs.next()){
             //  c=new commande(rs.getInt("idC"),rs.getInt("idU"),rs.getString("referenceP"),rs.getString("etatC"),rs.getString("livraison"),rs.getDouble("prixC"));
              c=new commande(rs.getInt("idC"),rs.getInt("idU"),rs.getString("etatC"),rs.getString("livraison"),rs.getDouble("prixC"));
               l.add(c);
